The TDS-1 is the first guitar pedal I ever built, and it shows. It's simple design is well suited for amateur and begginer use, since it doesn't require a large number of components.
